...
local travelersHearthstone = Action()
...
function travelersHearthstone.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
travelersHearthstone:id(20033)
travelersHearthstone:register()
