...
local provingGroundsLever = Action()

function provingGroundsLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
provingGroundsLever:aid(10041)
provingGroundsLever:register()
