...
local cinderforgeGate = Action()

local GATE_UNIQUE_ID = 10030

function cinderforgeGate.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
cinderforgeGate:aid(10022)
cinderforgeGate:register()
