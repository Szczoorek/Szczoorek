...
local twinsAIThink = CreatureEvent('TwinsAIThink')

function twinsAIThink.onThink(creature, interval)
...
twinsAIThink:register()

local twinsAIDeath = CreatureEvent('TwinsAIDeath')

function twinsAIDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	local monster = creature
