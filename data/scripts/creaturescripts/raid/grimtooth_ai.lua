...
local grimtoothAIThink = CreatureEvent('GrimtoothAIThink')

function grimtoothAIThink.onThink(creature, interval)
...
grimtoothAIThink:register()

local grimtoothAIDeath = CreatureEvent('GrimtoothAIDeath')

function grimtoothAIDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	local monster = creature
