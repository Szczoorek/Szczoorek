...
local ignarethAIThink = CreatureEvent('IgnarethAIThink')

function ignarethAIThink.onThink(creature, interval)
...
ignarethAIThink:register()

local ignarethAIDeath = CreatureEvent('IgnarethAIDeath')

function ignarethAIDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	local monster = creature
