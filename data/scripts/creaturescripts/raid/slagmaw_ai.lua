...
local slagmawAIThink = CreatureEvent('SlagmawAIThink')

function slagmawAIThink.onThink(creature, interval)
...
slagmawAIThink:register()

local slagmawAIDeath = CreatureEvent('SlagmawAIDeath')

function slagmawAIDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	local monster = creature
