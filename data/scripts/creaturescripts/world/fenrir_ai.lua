...
local fenrirAIThink = CreatureEvent('FenrirAIThink')

function fenrirAIThink.onThink(creature, interval)
...
fenrirAIThink:register()

local fenrirAIDeath = CreatureEvent('FenrirAIDeath')

function fenrirAIDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	local monster = creature
