...
local varekAIThink = CreatureEvent('VarekAIThink')

function varekAIThink.onThink(creature, interval)
...
varekAIThink:register()

local varekAIDeath = CreatureEvent('VarekAIDeath')

function varekAIDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	local monster = creature
