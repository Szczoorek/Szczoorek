...
local grixAIThink = CreatureEvent('GrixAIThink')

function grixAIThink.onThink(creature, interval)
...
grixAIThink:register()

local grixAIDeath = CreatureEvent('GrixAIDeath')

function grixAIDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	local monster = creature
