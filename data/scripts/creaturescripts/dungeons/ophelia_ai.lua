...
local opheliaAIThink = CreatureEvent('OpheliaAIThink')

function opheliaAIThink.onThink(creature, interval)
...
opheliaAIThink:register()

local opheliaAIDeath = CreatureEvent('OpheliaAIDeath')

function opheliaAIDeath.onDeath(creature, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	local monster = creature
